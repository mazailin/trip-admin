...
public class AppUserController extends BaseController {
	...
	public String save(AppUser appUser,@RequestParam(value = "photoFile",required = false) MultipartFile photoFile,Model model, RedirectAttributes redirectAttributes) {
		if (!beanValidator(model, appUser)){
			return form(appUser, model);
		}
		ResponseBo responseBo = appUserService.saveAppUser(appUser,photoFile);
