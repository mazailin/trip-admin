...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.ajax({
                url: ctx + '/tim/shop/findShopFiles',
                data: {
                    "id": "${shop.id}"
                },
                dataType: 'json',
...
<body>
	<ul class="nav nav-tabs">
        ...
        <li><a href="${ctx}/tim/shop/form?id=${shop.id}">购物<shiro:hasPermission name="tim:shop:edit">${not empty shop.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="tim:shop:edit">查看</shiro:lacksPermission></a></li>
		<li class="active"><a href="${ctx}/tim/shop/image?id=${shop.id}">购物图片<shiro:hasPermission name="tim:shop:edit">维护</shiro:hasPermission><shiro:lacksPermission name="tim:shop:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
    <form id="fileupload" class="form-horizontal" action="${ctx}/tim/shop/uploadData" method="POST"
          enctype="multipart/form-data">
        <sys:message content="${message}"/>
        <div class="control-group">
            <shiro:hasPermission name="tim:shop:edit">
            ...
            <table role="presentation" class="table table-striped">
                ...
                <shiro:hasPermission name="tim:shop:edit"><th>操作</th></shiro:hasPermission>
                </tbody>
            </table>
        </div>
    </form>
        ...
        <tr class="template-upload fade">
            ...
            <td>
                ...
                <select name="type" class="input-mini" required>
                    <c:forEach var="fileType" items="${fns:getDictList('shop_file_type')}">
            ...
            <td>
                {% if (file.id) { %}
                    <button class="btn btn-info update" data-type="POST"
                        data-url="${ctx}/tim/shop/updateFile">
                        <i class="glyphicon glyphicon-upload"></i>
                        <span>更新</span>
                    </button>
                    <button class="btn btn-danger delete" data-type="POST"
                        data-url="${ctx}/tim/shop/deleteFile"
