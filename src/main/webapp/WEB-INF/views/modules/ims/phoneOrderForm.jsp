    ...
    $(document).ready(function() {
      ...
      $(".calc").change(function(){
        ...
        if(quantity!=null&&isNaN(quantity)){
          ...
          quantity = quantity.substring(0,quantity.index(".")-1);
          $("#quantity").val(quantity);
          return false;
        }
...
<body>
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/ims/phoneOrder/form?id=${order.id}">手机信息${not empty order.id?'修改':'添加'}查看</a></li>
  </ul><br/>
  <form:form id="inputForm" modelAttribute="dict" action="${ctx}/ims/phoneOrder/save" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <form:input path="unitPrice" htmlEscape="false" maxlength="50" class="required" cssClass="calc"/>
      </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <form:input path="totalPrice" htmlEscape="false" maxlength="11" class="required"/>
      </div>
    </div>
    <div class="control-group">
