...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th class="sort-column name">产品</th><th>单位</th><th>下限</th><th>库存数量</th><th>在租数量</th><th>可用数量</th><th>总数</th><th>操作</th></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="product">
			<tr>
                ...
                <td>
                    <a href="${ctx}/iom/product/in/form?product.id=${product.id}&product.name=${product.name}&product.code=${product.code}&product.useDetail=${product.useDetail}">入库</a>
                    <c:choose>
