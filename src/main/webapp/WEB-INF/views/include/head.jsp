<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://zhangxd.cn/"/>
...
<script src="${ctxStatic}/pagination/jquery.twbsPagination.min.js" type="text/javascript"></script>
